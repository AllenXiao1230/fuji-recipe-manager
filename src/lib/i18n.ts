...
const copy = {
  en: {
    ...
    matrixAuditUnverified: "Run read-only unknown-property audit",
    matrixAuditComplete: "Read-only audit complete. Results were added to the evidence notes; no camera setting was changed.",
    matrixModel: "Model",
  ...
  "zh-TW": {
    ...
    matrixAuditUnverified: "執行未知屬性唯讀稽核",
    matrixAuditComplete: "唯讀稽核完成；結果已加入證據備註，未變更任何相機設定。",
    matrixModel: "機型",
    matrixFirmware: "韌體",
    matrixUsbIds: "USB ID",
    matrixSlots: "自訂槽位",
